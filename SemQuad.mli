...
val set_main : Symbol.entry -> Symbol.entry

val sq_rout_head : string -> Types.typ -> (Types.typ * (string * Symbol.pass_mode * quad_op_t list)) list -> bool -> Symbol.entry
...
val st_write : int -> (semv_expr * semv_expr * semv_expr) list -> semv_stmt



(* Runtime Library *)

val register_runtime_library : unit -> unit
